package com.turkcell.paymentservice.polling;
...
import com.turkcell.paymentservice.entity.OutboxStatus;
import com.turkcell.paymentservice.repository.OutboxRepository;

/** Transactional Outbox relay: PENDING reply'lari saga-replies topic'ine publish eder. */
@Component
